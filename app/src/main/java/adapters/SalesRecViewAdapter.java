...
public class SalesRecViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SalesRecViewAdapter(Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        final View view = LayoutInflater.from(context).inflate(R.layout.item_sale_rv, parent, false);
    ...
    private static class CellFeedViewHolder extends RecyclerView.ViewHolder {
        ...
        CellFeedViewHolder(View view) {
            ...
            ivFeedBottom = view.findViewById(R.id.ivFeedBottom);
